...
trace_expression('Main', Main) :- (Stack=gen([id, s], ((size(var(id), var(s))*app(Stack, [var(id), var(s)]))\/optional(var(val, (push(var(id), var(val))*(app(Stack, [var(id), (var(s) + 1)])*(pop(var(id), var(val))*app(Stack, [var(id), var(s)]))))))))),
	(Stacks=optional(var(id, (new(var(id))*(Stacks|(app(Stack, [var(id), 0])*free(var(id)))))))),
