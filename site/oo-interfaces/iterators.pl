...
trace_expression('Main', Main) :- (Main=((relevant_et>>Iterators);1)),
	(Iterators=optional(var(id, (newIter_et(var(id))*(app(Iterator, [var(id)])|Iterators))))),
	(Iterator=gen([id], (star((hasNext_et(var(id), true)*next_et(var(id))))*hasNext_et(var(id), false)))).
